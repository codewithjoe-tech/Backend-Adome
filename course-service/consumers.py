...
import json
import logging
from  consume_utils import  user_callback , tenant_callback , tenantuser_callback,order_callback
...
channel.queue_declare('course-service' , durable=True , )
channel.queue_bind('course-service', 'appevents', 'app.*.*')
channel.basic_consume(queue='course-service', on_message_callback=callback, auto_ack=False)
