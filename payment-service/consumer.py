...
channel.queue_declare('payment-service' , durable=True , )
channel.queue_bind('payment-service', 'appevents', 'app.*.*')
channel.basic_consume(queue='payment-service', on_message_callback=callback, auto_ack=False)
