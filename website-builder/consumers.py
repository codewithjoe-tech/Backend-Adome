...
channel.queue_declare('webbuilder-service' , durable=True , )
channel.queue_bind('webbuilder-service', 'appevents', 'app.*.*')
channel.basic_consume(queue='webbuilder-service', on_message_callback=callback, auto_ack=False)
