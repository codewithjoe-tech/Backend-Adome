...
channel.queue_declare('comment-service' , durable=True , )
channel.queue_bind('comment-service', 'appevents', 'app.*.*')
channel.basic_consume(queue='comment-service', on_message_callback=callback, auto_ack=False)
